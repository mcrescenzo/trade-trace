...
def test_journal_init_with_no_network_succeeds(no_socket_creation, tmp_path: Path):
    home = tmp_path / "home"
...
def test_journal_status_reports_none_default(no_socket_creation, tmp_path: Path):
    home = tmp_path / "home"
...
def test_memory_retain_and_recall_offline(no_socket_creation, tmp_path: Path):
