...
## 5. Tool-schema/help language

Future MCP and CLI descriptions may reuse this compact wording:
...
- “Open paper positions: 2; paper exposure is local to Trade Trace.”
- “Watch-only idea found; not counted as exposure.”
