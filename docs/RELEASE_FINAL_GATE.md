...
4. Public tool catalog is verified against runtime/schema expectations and documented as 77 public tools (the live `build_registry().public_names()` count; update this gate when the catalog count changes).
