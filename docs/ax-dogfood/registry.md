...
| AX-018 | 2026-06-03-03 | report | `report.work_queue` flags resolve_due_forecast on a still-live market (mid 0.505, accepting_orders:true) solely from resolution_at_missing (AX-012 inverse) | filed | trade-trace-fe2f (design Q) |
