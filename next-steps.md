...
7. **Tool catalog:** ~84 → ~45 tools (~46% reduction). [AUDIT 2026-05-22: actual registered baseline is 84, not ~81; target rose by 1 with `snapshot.fetch_series` added to NEW adapter primitives.]
