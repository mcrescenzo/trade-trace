...
EVENT_TYPE_EXPECTATIONS: Final[tuple[EventTypeExpectation, ...]] = (
    ...
    EventTypeExpectation("account_snapshot.imported", AutonomousRecordFamily.ACCOUNT_SNAPSHOT, frozenset({"semantic_key", "source_kind", "source_ref", "as_of", "imported_at"}), "Caller-supplied sanitized account snapshot evidence; local evidence only, not fetched broker truth."),
